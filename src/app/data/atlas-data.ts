...
export const processData: Record<string, ProcessStep[]> = {
  ...
  "organic-cotton": [
    { name: "Cultivation", detail: "Grown without synthetic inputs; rain-fed with crop rotation" },
    { name: "Picking", detail: "Bolls hand-picked at maturity to preserve fiber quality" },
    { name: "Ginning", detail: "Seeds separated from lint fibers by saw or roller gin" },
    { name: "Carding", detail: "Fibers aligned into a thin web, then condensed into sliver" },
    { name: "Combing", detail: "Short fibers removed; remaining long staple paralleled" },
    { name: "Ring Spinning", detail: "Drawn and twisted into yarn on ring frames at high speed" },
  ],
  silk: [
...
export const anatomyData: Record<string, AnatomyData> = {
  ...
  "organic-cotton": { diameter: { raw: "12-22 \u00b5m" }, crossSection: "Kidney-bean / collapsed tube", surfaceTexture: "Twisted ribbon (convolutions)", length: { raw: "20-40 mm (staple)", minMm: 20.0, maxMm: 40.0 }, tensileStrength: { raw: "287-597 MPa", minMPa: 287.0, maxMPa: 597.0 }, moistureRegain: { raw: "8.5%", percentage: 8.5 } },
