...
import { atlasNavigation as runtimeAtlasNavigation, type NavNode as RuntimeNavNode, getCategoryForNavNode } from "../../data/admin/atlas-navigation";
import {
...
export function buildKnowledgeFibers(
  ...
  return orderedIds.map((id) => {
    ...
    const fallbackCategory =
      (typeof contentItem?.nodeData?.category === "string" && contentItem.nodeData.category.trim()) ||
      (typeof contentItem?.passport?.category === "string" && contentItem.passport.category.trim()) ||
      (navLabelById.has(id) ? getCategoryForNavNode(navigationNodes, id) : "fiber");
    const image =
      getImageForId?.(id) ??
      (() => {
